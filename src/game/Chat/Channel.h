...
class Channel
{
    ...
    public:
        ...
        uint32 GetChannelId() const { return (m_entry ? m_entry->GetChannelID() : 0); }
        entry::view::ChatChannelView GetChannelEntry() const { return m_entry; }
    ...
    private:
        ...
        GuidSet                       m_banned;
        entry::view::ChatChannelView  m_entry;
